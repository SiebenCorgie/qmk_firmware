...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_ortho_5x12(
        ...
        KC_LCTL, _______, _______, KC_LGUI, KC_LALT, KC_SPC, KC_ENT, LF,   KC_BSPC, _______, _______, _______),
    ...
    [_LEVEL4] = LAYOUT_ortho_5x12(
        ...
        _______, KC_PAGE_UP, KC_BSPC, KC_UP,   KC_DEL,   KC_PAGE_DOWN, _______, KC_7,    KC_8,    KC_9,    KC_0,    KC_PSCR,
        _______, _______,    KC_LEFT, KC_DOWN, KC_RIGHT, KC_END,       _______, KC_4,    KC_5,    KC_6,    _______, KC_VOLU,
